  ...
  methods: {
    ...
    data_car() {
      ...
      if (localStorage.getItem("zaozuo_token") != null) {
        let goods = JSON.parse(sessionStorage.getItem(localStorage.getItem("zaozuo_name")));
        this.data = goods;
      } else {
    ...
    del(idx) {
      ...
      sessionStorage.setItem(localStorage.getItem("zaozuo_name"), JSON.stringify(this.data));
    },
