<template>
  <div class="page__bd page__bd_spacing">
    ...
    <div class="weui-flex">
      <div class="weui-flex__item">
        <div class="placeholder">
          <p class="Engoodsname">Bloom Side Table</p>
        </div>
      </div>
    </div>
    <div class="weui-flex">
...
export default {
  ...
  methods: {
    async shuju() {
      ...
      this.$store.commit('upd_imgurl', this.res.imgurl);
      this.$store.commit('upd_name', this.res.goodsname);
      this.$store.commit('upd_price', this.res.price);
    }
  },
  created() {
    this.shuju();
